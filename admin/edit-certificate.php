	      ...
	      <form action="#" method="post" enctype= "multipart/form-data">
              <div class="form-group">
                <label class="text-label">SL NO.</label>
                 <input type="hidden" name="reg_no" value="<?php echo $id; ?>">
                 <input type="text" class="form-control" name="sid" placeholder="Enter a sl no.." value="<?php echo isset($newcerificate)?$newcerificate['serail_no']: ''; ?>" readonly>
              </div>
               <div class="form-group">
                <label class="text-label">Reg No</label>
                  <input type="text" class="form-control"  name="regno" value="<?php  echo isset($newcerificate)?$newcerificate['reg_no']:''; ?>" readonly>
               </div>  
              <div class="form-group">
                ...
                <label for="in_year" class="col-sm-4 col-form-label text-left">Completion Date</label>
                    <div class="col-sm-4">
                         <select name="mounth" class="select2 form-control mb-3  required custom-select">
                         <option value="<?php echo isset($newcerificate['c_mounth'])?$newcerificate['c_mounth']=='<?php echo $val; ?>'?'selected':'':'';?>">Select Month</option>
                             <?php
                                  foreach($da->getmonths() as $val)
                                  {
                                    ?>
                        <option value="<?php echo $val; ?> <?php echo isset($newcerificate['c_mounth'])?$newcerificate['c_mounth']=='<?php echo $val; ?>'?'selected':'':'';?>"><?php echo $val; ?></option>
                            <?php
                                }
                                  ?>                                                               
                        </select>
                    ...
                    <div class="col-sm-4">
                      <select name="year" class="select2 form-control mb-3  required custom-select">
               ...
               <div class="form-group">
                ...
                <div class="input-group input-append date" id="datePicker">
                  <input type="text" class="form-control" id="val-username1"  placeholder="Enter A DOI..." name="doa" value="<?php echo isset($newcerificate)?$newcerificate['certificate_issue']:'';?>">
                ...
                <select class="form-control" name="certificate_type" id="certificate_type" onchange="showhide()">
                   <option value="other_certificate" <?php echo isset($newcerificate['certificate_type'])?$newcerificate['certificate_type']=='other_certificate'?'selected':'':'';?>>Other Certificate Issue</option> 
                   <option value="typing_certificate" <?php echo isset($newcerificate['certificate_type'])?$newcerificate['certificate_type']=='typing_certificate'?'selected':'':'';?>>Typing Certificate Issue</option> 
                </select>
              </div>
              <div class="form-group hid1">
                <div class="col-md-6">
                    <label class="text-label">Gross English Speed</label>
                    <input type="text" class="form-control" name="gross_speed_eng" style='text-transform:uppercase' onchange="grade_typing()" value="<?php echo isset($newcerificate)?$newcerificate['gross_speed']:'';?>" placeholder="English Gross Speed"  id="gross_speed_eng">
                </div>
                <div class="col-md-6">
                    <label class="text-label">Gross Hindi Speed</label>
                    <input type="text" class="form-control" name="gross_speed_hindi" style='text-transform:uppercase' onchange="grade_typing()" value="<?php echo isset($newcerificate)?$newcerificate['hindi_gross_speed']:'';?>" placeholder="Hindi Gross Speed" id="gross_speed_hindi">
                </div>
              </div>
              <div class="form-group hid1">
                <div class="col-md-6">
                    <label class="text-label">Net English Speed</label>
                    <input type="text" class="form-control" name="net_speed_eng" style='text-transform:uppercase' onchange="grade_typing()" value="<?php echo isset($newcerificate)?$newcerificate['net_speed']:'';?>"  placeholder="Net English Speed" id="net_speed_eng">
                </div>
                <div class="col-md-6">
                    <label class="text-label">Net Hindi Speed</label>
                    <input type="text" class="form-control" name="net_speed_hindi" style='text-transform:uppercase' onchange="grade_typing()" value="<?php echo isset($newcerificate)?$newcerificate['hindi_net_speed']:'';?>"  placeholder="Net Hindi Speed" id="net_speed_hindi">
                </div>
              </div>
               <div class="form-group hid1">
                <label class="text-label">accuracy</label>
                <input type="text" class="form-control" name="accuracy"   value="<?php echo isset($newcerificate)?$newcerificate['accuracy']:'';?>"   id="accuracy">
              </div>
               <div class="form-group hid1">
                <label class="text-label">Short-hand Speed(WPM) </label>
                <input type="number" class="form-control" name="short_hand_speed" value="<?php echo isset($newcerificate)?$newcerificate['short_hand_speed']:'';?>" id="short_hand_speed">
              </div>
               <div class="form-group hid1">
                <label class="text-label">Typing Grade</label>  
                <input type="text" class="form-control" readonly="" name="typing_grade" value="<?php echo isset($newcerificate)?$newcerificate['typing_grade']:'';?>"  id="tye_grade">
              </div>
               <div class="form-group hid2">
                <label class="text-label">Written Mark</label>
                <input type="number" class="form-control" placeholder="Enter a Written Mark.." name="written" value="<?php echo isset($newcerificate)?$newcerificate['written_mark']:'';?>" onchange="grade_normal()"  id="written">
              </div> 
              <div class="form-group hid2">
                <label class="text-label">Pract Mark </label>
                <input type="number" class="form-control" placeholder="Enter a Pract Mark.." name="pract" value="<?php echo isset($newcerificate)?$newcerificate['practice_mark']:'';?>" onchange="grade_normal()"  id="practical">
              </div>
              <div class="form-group hid2">
                <label class="text-label">Viva</label>
                  <input type="number" class="form-control" placeholder="Enter A Viva" name="viv" value="<?php echo isset($newcerificate)?$newcerificate['viva']:'';?>" onchange="grade_normal()"  id="viva">
               </diV>          
               <div class="form-group hid2">
                <label class="text-label">Assign Mark</label> 
                  <input type="number" class="form-control" placeholder="Enter a Assign Mark..." name="Assign" value="<?php echo isset($newcerificate)?$newcerificate['assign_mark']:'';?>" onchange="grade_normal()"  id="assignment">
                </div>
              <div class="form-group hid2">
                <label class="text-label">Grade</label>
                <input type="text" class="form-control" placeholder="Enter A Grade" name="grd" value="<?php echo isset($newcerificate)?$newcerificate['grade']:'';?>" readonly id="grade">
              </div>
             <div class="from row">
              ...
              <div class="position-center" style="text-align: center;">          
                     <button style="text-align: center;" type="submit" class="btn btn-success" name="bupdate"><i class="fa fa-edit"></i>Update</button>           
             </div>
            </form>
