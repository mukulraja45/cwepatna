	 ...
	 <form action="" method="POST"  enctype= "multipart/form-data">
            <div class="form-row">
             <!--<div class="form-group col-md-12">
                <label for="stunm"><font color="red">(*)</font>Sl No:-</label> 
                <input type="text" class="form-control" name="serail_no" value="<?php echo $sl_no; ?>" required>
              </div>
            </div>-->
              <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <select class="form-control" name="course" id="category" onchange="getcourse();" required>
              ...
              <div class="form-group col-md-6">
                 ...
                 <select class="form-control" name="coursenm" id="coursenm" onchange="getfee()" value="<?php echo isset($studentdetails)?$studentdetails['course_nm']:'';?>" required>    
                 </select>
              </div>
              </div>
              <div class="form-row">
               <div class="form-group col-md-6">
                 ...
                 <input type="text" class="form-control" id="cfee" placeholder="Enter course Fee" name="cfee"  value="<?php echo isset($studentdetails)?$studentdetails['course_fee']:'';?>" required>
                </div>
                <div class="form-group col-md-6">
